    ...
    <>
       <main>
        <div class={styles.main + ' ' + styles.conteudo + ' ' + styles.padding_padrao}>
          ...
          <CardAdmin name="Cadastrar Administradores" desc="Adicione novos administradores ao seu sistema!" src={admin_img} button="Cadastrar" />
          <CardAdmin name="Editar cadastro" desc="Edite os seus dados pessoais informados no cadastro!" src={editar_img} button="Editar"/> 
